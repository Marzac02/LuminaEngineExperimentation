...
namespace Lumina
{
    ...
    REFLECT()
    class LUMINA_API CComponentVisualizerRegistry : public CObject
    {
        GENERATED_BODY()
    public:
    ...
    REFLECT()
    class LUMINA_API CComponentVisualizer : public CObject
    {
        GENERATED_BODY()
    public:
    ...
    REFLECT()
    class LUMINA_API CComponentVisualizer_PointLight : public CComponentVisualizer
    {
        GENERATED_BODY()
    public:
    ...
    REFLECT()
    class LUMINA_API CComponentVisualizer_SphereCollider : public CComponentVisualizer
    {
        GENERATED_BODY()
    public:
    ...
    REFLECT()
    class LUMINA_API CComponentVisualizer_BoxCollider : public CComponentVisualizer
    {
        GENERATED_BODY()
    public:
